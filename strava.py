...
class Strava:
    ...
    def call_api(self,url,args=None):
        ...
        try:
            ...
            print "Error calling urlopen().read() Strava site down ?"
        else:
            return urlf
    ...
    def get_segment_info(self,segment_id):
        ...
        return self.process_strava_json_data(self.call_api(segment_id_api_url))
    ...
    def get_club_members(self,club_id):
        ...
        return club_mem_data

    # XXX needs to change args list here dict based statement
